...
def sample_ar(unet_path, data_path, id=None, prompt=None):
...
def sample_next_frame(frame_id, unet, scheduler, current_latents, txt_embedding, device):
    latents = torch.randn((1, 4, 64, 64), device=device)
...
if __name__ == "__main__":
    for i in range(10):
        sample_ar(
            ...
            unet_path="/home/jiachun/codebase/vid_gen/experiment/dev/dev-unet-0",
